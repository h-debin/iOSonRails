...
- (void)viewDidLoad {
     ...
     */
    News *new0 = [[News alloc] initWithDictionary:@{@"title": @"中日韩开外长会 王毅称中韩与日关系严重受干扰",
    ...
    self.view = [NavSubView initWithEmotionCategory:@"今日最哀"
...
- (void) handleSwipe:(UISwipeGestureRecognizer *)swipe {
    ...
    if (swipe.direction == UISwipeGestureRecognizerDirectionRight) {
        JingViewController *jingViewController = [[JingViewController alloc] init];
        [self presentViewController:jingViewController
                           animated:YES
                         completion:^{
                             NSLog(@"Present Done");
                         }
